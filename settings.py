class Settings():
    ...
    WIDTH = 21                          # Width for Hero
    HEIGHT = 33                         # Height for Hero
    COLOR =  "#888888"                  # Color for Hero(if not Hero image)
    JUMP_POWER = 10                     # Jump length too
    GRAVITY = 0.5                       # Power for Gravitation

    # настройки анимаци
    ANIMATION_DELAY = 100                                          # Speed changing animation per Second.
    ANIMATION_DELAY_STAY = 200
    ...
    ANIMATION_JUMP_LEFT = [('sprites/player/jumpl.png', 1)]    # Animation for moving left with jump
    ANIMATION_JUMP_RIGHT = [('sprites/player/jump.png', 1)]    # Animation for moving right with jump
    ANIMATION_JUMP = [('sprites/player/jump.png', 1)]               # Jump animation
    ANIMATION_STAY = [('sprites/player/stay.png'),
                      ('sprites/player/stay2.png'),
                      ('sprites/player/stay3.png'),
                      ('sprites/player/stay4.png')]
